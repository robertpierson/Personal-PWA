...
import { CREDIT_EXPLAINER } from "@/content/credits";
  ...
  return (
    <div ref={ref} className="relative">
      ...
      >
        ...
        <span className="tabular-nums">{remaining.toLocaleString()}</span> credits
      </button>
      ...
      {open && (
        <div className="shadow-lift absolute right-0 z-50 mt-2 w-72 rounded-[var(--radius-card)] border border-line bg-panel p-4">
          ...
          <p className="mt-1 text-xs text-ink-faint">{CREDIT_EXPLAINER}</p>
